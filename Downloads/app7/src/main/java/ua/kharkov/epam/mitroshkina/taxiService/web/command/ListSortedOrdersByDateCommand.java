...
public class ListSortedOrdersByDateCommand extends Command {
    private static final long serialVersionUID = 3797729831723183924L;

    private static final Logger log = Logger.getLogger(ListSortedOrdersByDateCommand.class);
    ...
    public String execute(HttpServletRequest request,
        ...
        List<ConfirmedOrderBean> confirmedOrderBeanList = new ClientOrderDao().sortConfirmedOrderBeansByDate();
